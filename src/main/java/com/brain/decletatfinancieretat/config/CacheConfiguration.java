package com.brain.decletatfinancieretat.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinancieretat");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinancieretat");
        ...
        config.getMapConfigs().put("com.brain.decletatfinancieretat.domain.*", initializeDomainMapConfig(jHipsterProperties));
