...
@RestController
@RequestMapping("/api/decletatfinancieretat-kafka")
public class DecletatfinancieretatKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DecletatfinancieretatKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DecletatfinancieretatKafkaResource(KafkaProperties kafkaProperties) {
