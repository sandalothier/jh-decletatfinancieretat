package com.brain.decletatfinancieretat.web.rest;

import com.brain.decletatfinancieretat.config.KafkaProperties;
...
class DecletatfinancieretatKafkaResourceIT {
    ...
    void setup() {
        ...
        DecletatfinancieretatKafkaResource kafkaResource = new DecletatfinancieretatKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancieretat-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/decletatfinancieretat-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
